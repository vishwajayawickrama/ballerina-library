...
# Builds the trigger user message containing only the dynamic/variable parts:
# trigger name, trigger package, code-server URL, and absolute artifact paths.
# Trigger rules, template structure, and formatting instructions live in
# system_prompt_trigger.bal.
#
