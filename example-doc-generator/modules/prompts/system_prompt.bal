...
public function buildSystemPrompt(string projectRoot, string triggerName, string triggerPackage, string screenshotPrefix, string sampleName) returns string {
    string bt = "`";
